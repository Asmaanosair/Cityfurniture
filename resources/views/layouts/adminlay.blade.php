        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="city/images/logo.jpg" class="img-circle" alt="User Image">
                </div>
                <div class="pull-left info">
                    <p>City for furniture</p>
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li><a href="/.en"><i class="fa fa-book"></i> <span>Web Site</span></a></li>
                <li class="treeview">
                    <a href="#">
              ...
              <span class="label label-primary pull-right">2</span>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/product')}}"><i class="fa fa-circle-o text-red"></i> Show All Products </a></li>
                        <li><a href="{{url('/create')}}"><i class="fa fa-circle-o text-yellow"></i> Add New Products</a></li>
                    </ul>
                </li>
              ...
              <span class="label label-primary pull-right">2</span>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/item')}}"><i class="fa fa-circle-o text-red"></i> Show All Items </a></li>
                        <li><a href="{{url('/cr_item')}}"><i class="fa fa-circle-o text-yellow"></i> Add New Item</a></li>
                    </ul>
                </li>
                <li class="header">LABELS</li>
                <li><a href="{{url('/slider')}}"><i class="fa fa-circle-o text-yellow"></i> <span>Slider</span></a></li>
                <li><a href="{{url('/contact')}}"><i class="fa fa-circle-o text-red"></i> <span>Contact</span></a></li>
